    ...
    function showFirstUseIntro() {
        ...
        intro.innerHTML = `
            <div class="first-use-card">
                ...
                <button id="startUsingButton" type="button">
                    开始使用
                </button>
